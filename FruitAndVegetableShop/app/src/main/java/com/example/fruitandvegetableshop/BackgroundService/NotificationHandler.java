package com.example.fruitandvegetableshop.BackgroundService;
...
public class NotificationHandler {
    ...
    private void createChannel() {
        ...
        channel.setDescription("Notifications from Vegetable And Fruit Shop application");
    ...
    public void send(String message) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext, CHANNEL_ID)
                .setContentTitle("Vegetable And Fruit Shop Application")
